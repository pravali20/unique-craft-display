...
const Certifications = () => {
  ...
  date: "2024-2025",
  description:
    "Completed all three modules of Cisco's Networking Essentials course. Gained strong foundational knowledge in networking, including IP addressing, routing, LAN/WAN design, and troubleshooting.",
  skills: ["Networking", "IP Addressing", "Routing", "Subnetting", "LAN/WAN"],
  color: "from-blue-500 to-cyan-500",
  icon: "🌐",
  credentialUrl: "https://drive.google.com/drive/folders/10F2WWv53Z4B_bs-7wocnnhqsKFuIaIaG?usp=sharing", // optional shared folder
  extraLinks: [
    {
  ...
  date: "2024",
  description:
    "Completed a course on frontend development covering the basics of HTML, CSS, and JavaScript. Learned how to create responsive and user-friendly web pages.",
